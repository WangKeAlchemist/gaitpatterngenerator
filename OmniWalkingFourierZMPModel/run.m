...
for i=1:numStep
    ...
    for t=0:0.002:(tf-0.002)
        ...
        [zmpx1 zmpy1]=ZMPAPPROX(tposx(i),tposy(i),sposx(i),sposy(i),tposx(i+1),tposy(i+1),t0,t1,t2,tf,t); % Approximte ZMP Trajectory Using Fourier Series
        [ux uy]= FourierCoM(tposx(i),tposy(i),sposx(i),sposy(i),tposx(i+1),tposy(i+1),t0,t1,t2,tf,t); % Compute CoM Postion Based on Fourier approximation
